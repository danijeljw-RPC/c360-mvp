...
('10000001-0000-0000-0000-000000000001', 'a0000003-0000-0000-0000-000000000003', 'CCA-APAC', 'Coca-Cola APAC Travel Policy', 2, 'f0000002-0000-0000-0000-000000000002'),
('10000002-0000-0000-0000-000000000002', 'a0000003-0000-0000-0000-000000000003', 'CCA-EMEA', 'Coca-Cola EMEA Travel Policy', 2, 'f0000003-0000-0000-0000-000000000003'),
('10000003-0000-0000-0000-000000000003', 'a0000003-0000-0000-0000-000000000003', 'CCA-NA', 'Coca-Cola North America Policy', 1, 'f0000001-0000-0000-0000-000000000001'),
('10000004-0000-0000-0000-000000000004', 'a0000003-0000-0000-0000-000000000003', 'CCA-EXEC', 'Coca-Cola Executive Travel Policy', 3, NULL),
('10000005-0000-0000-0000-000000000005', 'a0000003-0000-0000-0000-000000000003', 'CCA-TRIAL', 'Coca-Cola Trial/Shadow Policy', 5, NULL)
ON CONFLICT DO NOTHING;
...
('20000001-0000-0000-0000-000000000001', 'a0000003-0000-0000-0000-000000000003', 'TRV-CCA-001', 'Jordan', 'Nguyen', 'jordan.nguyen@example.test', 'APAC-SALES'),
('20000002-0000-0000-0000-000000000002', 'a0000003-0000-0000-0000-000000000003', 'TRV-CCA-002', 'Avery', 'Williams', 'avery.williams@example.test', 'EMEA-MARKETING'),
('20000003-0000-0000-0000-000000000003', 'a0000003-0000-0000-0000-000000000003', 'TRV-CCA-003', 'Morgan', 'Patel', 'morgan.patel@example.test', 'NA-FINANCE'),
('20000004-0000-0000-0000-000000000004', 'a0000003-0000-0000-0000-000000000003', 'TRV-CCA-004', 'Taylor', 'Chen', 'taylor.chen@example.test', 'EXEC')
ON CONFLICT DO NOTHING;
